<div class="breadcrumb-area pt-205 breadcrumb-padding pb-210" style="background-image: url(<?= base_url('assets/img/bg/breadcrumb.jpg'); ?>)">
  <div class="container-fluid">
    <div class="breadcrumb-content text-center">
      <h2>Tops Collections</h2>
      <ul>
        <li><a href="#">Shop</a></li>
        <li>Tops</li>
      </ul>
            ...
            <div class="shop-bar pb-60">
              ...
              <div class="shop-filter-tab">
                <div class="shop-tab nav" role=tablist>
                  <a class="active" href="#grid-sidebar3" data-bs-toggle="tab" role="tab" aria-selected="false">
                    ...
                    <div class="product-wrapper mb-30">
                      <div class="product-img">
                        ...
                        <div class="product-action">
                          ...
                          <a class="animate-right" title="Quick View" data-bs-toggle="modal" data-bs-target="#exampleModal" href="<?= base_url('Shop/product'); ?>">
